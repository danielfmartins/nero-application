...
public class HashtagTotalHitByYear implements Serializable {
	...
	public HashtagTotalHitByYear() {
		super();
	}

	public HashtagTotalHitByYear(Integer year, Qualifiable qualifiable, Hashtag hashtag,
			Long hits) {
		this();
		this.setYear(year);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		HashtagTotalHitByYear other = (HashtagTotalHitByYear) obj;
		if (hashtag == null) {
