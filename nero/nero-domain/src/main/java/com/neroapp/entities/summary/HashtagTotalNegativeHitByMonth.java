...
public class HashtagTotalNegativeHitByMonth {
	...
	public HashtagTotalNegativeHitByMonth() {
		super();
	}

	public HashtagTotalNegativeHitByMonth(Integer year, Integer month,
			Qualifiable qualifiable, Hashtag hashtag, long hits) {
		this();
		this.setYear(year);
		this.setMonth(month);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		HashtagTotalNegativeHitByMonth other = (HashtagTotalNegativeHitByMonth) obj;
		if (hashtag == null) {
