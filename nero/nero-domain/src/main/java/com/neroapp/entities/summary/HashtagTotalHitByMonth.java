...
public class HashtagTotalHitByMonth {
	...
	public HashtagTotalHitByMonth() {
		super();
	}

	public HashtagTotalHitByMonth(Integer year, Integer month, Qualifiable qualifiable,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		HashtagTotalHitByMonth other = (HashtagTotalHitByMonth) obj;
		if (hashtag == null) {
