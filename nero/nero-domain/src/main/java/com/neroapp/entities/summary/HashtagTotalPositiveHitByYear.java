...
public class HashtagTotalPositiveHitByYear implements Serializable {
	...
	public HashtagTotalPositiveHitByYear() {
		super();
	}

	public HashtagTotalPositiveHitByYear(Integer year, Qualifiable qualifiable, Hashtag hashtag,
			Long hits) {
		this();
		this.setYear(year);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		HashtagTotalPositiveHitByYear other = (HashtagTotalPositiveHitByYear) obj;
		if (hashtag == null) {
